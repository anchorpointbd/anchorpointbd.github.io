...
const facultyContent={
  engineering:{eyebrow:'KNOWLEDGE AREA 01 · DEEP FIRST',title:'Engineering',description:'Move from discipline to method: calculate, question, learn and verify against the evidence that governs the work.',departments:[['civil','Civil and Infrastructure','Structures · water · construction · public systems'],['mechanical','Mechanical and Manufacturing','Machines · fluids · production · maintenance'],['marine','Naval and Marine','Ships · ports · propulsion · marine operations'],['electrical','Electrical and Electronics','Power · machines · protection · control'],['energy','Energy and Environment','Efficiency · utilities · emissions · resources'],['computing','Computing and Systems','Data · automation · software · interfaces'],['materials','Materials and Welding','Selection · joining · failure · quality']]},
  business:{eyebrow:'KNOWLEDGE AREA 02 · FOUNDATION',title:'Projects and Business',description:'Connect technical requirements with scope, procurement, interfaces, delivery and operational consequence.',departments:[['business','Project Strategy','Scope · stakeholders · outcomes · constraints'],['business','Procurement and Supply','Requirements · offers · interfaces · lifecycle'],['business','Operations','Capacity · reliability · handover · improvement']]},
