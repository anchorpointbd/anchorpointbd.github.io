...
const select=document.querySelector('#libraryDepartment');select?.addEventListener('change',()=>root.querySelectorAll('[data-library-department]').forEach(card=>card.hidden=select.value!=='all'&&card.dataset.libraryDepartment!==select.value));
window.anchorPointCalculatorCount=defs.length;
})();
